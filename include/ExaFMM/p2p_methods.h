 ...
 *
 ******************************************************************************/
#ifndef INCLUDE_EXAFMM_P2P_METHODS_H_
#define INCLUDE_EXAFMM_P2P_METHODS_H_
...
namespace ExaFMM {
    ...
    **/
    ...
    private:
        ...
        template <int Rows = dynamic>
        using potential_grad_vector_t = typename pt::template potential_grad_vector_t<Rows>;
...
#endif // INCLUDE_EXAFMM_P2P_METHODS_H_
